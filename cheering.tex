...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\node[xshift=7.6cm,yshift=0.2cm+sin(10*\thepage)*cos(10*\thepage)*0.2cm,inner sep=0pt](bee){\includegraphics[scale=0.75]{images/tikzbee}};
\node[cloud callout,callout absolute pointer={(bee.north)},align=center,fill=white!80!yellow,inner sep=0pt,font=\fontsize{5pt}{6pt}\selectfont] at ([xshift=0.1cm,yshift=0.3cm]bee.north east) {more\\ Beees};
   
\cat[xshift=6.7cm,yshift=-1.8cm,scale=0.8]
\hippo[xshift=7.2cm,yshift=-2cm,scale=0.8]
...
\pig[xshift=5cm,yshift=-3cm,scale=0.8]
