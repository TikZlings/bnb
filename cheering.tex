...
% confetti
\node at ({5.4+cos(\thepage)},{28.8-0.0972*(\thepage)}) {\includegraphics[width=\paperwidth,page=1]{confetti}};
...
\begin{scope}[scale=0.35,xshift=5.5cm,yshift=-13cm, transform shape]
    ...
    \node[red!80!black,scale=4,
		font=\ECFTeenSpirit\fontsize{22}{22}\selectfont,]
    at (7,18.5) {.};
      \node[red!80!black,scale=6,rotate=87,
		font=\ECFTeenSpirit\fontsize{22}{22}\selectfont,]
    at (13,24) {.};
	...
	\end{scope}
	\begin{scope}[scale=1.8,rotate=-30,yshift=7.5cm,xshift=-3.2cm]
		% Head %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		\fill[sloth] 
...
% confetti
\node at ({5.4+sin(\thepage)},{28.8-0.0972*(\thepage)}) {\includegraphics[width=\paperwidth,page=2]{confetti}};
