...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{scope}[scale=0.35,xshift=6cm,yshift=-13cm, transform shape]
	...
	\end{scope}
	\begin{scope}[xshift=18cm, scale=3]
		\duck[cap]% Assistant %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\end{scope}
	% Banner %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\node[
		...
		outer sep=0pt,
		inner sep=0.2cm
	] (writing) at (10,20) {Welcome Barbara!!!};
	\draw[line width=6pt, brown] (writing.south west) -- +(1,-15); 
	\draw[line width=6pt, brown] (writing.south east) -- +(-2,-15);
\end{scope}
